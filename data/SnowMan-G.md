...
https://github.com/code-423n4/2022-09-vtvl/blob/f68b7f3e61dad0d873b5b5a1e8126b839afeab5f/contracts/VTVLVesting.sol#L280
...
https://github.com/code-423n4/2022-09-vtvl/blob/f68b7f3e61dad0d873b5b5a1e8126b839afeab5f/contracts/VTVLVesting.sol#L300

3. Using calldata instead of memory for read-only arguments in external functions
...
5. For-Loops: Index increments can be left unchecked
...
6.  Arithmetics: ++i costs less gas compared to i++ or i += 1

++i costs less gas compared to i++ or i += 1 for unsigned integers, as pre-increment is cheaper (about 5 gas per iteration). This statement is true even with the optimizer enabled.

https://github.com/code-423n4/2022-09-vtvl/blob/f68b7f3e61dad0d873b5b5a1e8126b839afeab5f/contracts/VTVLVesting.sol#L353

7. Arithmetics: Unchecking arithmetic operations that cannot underflow/overflow
...
https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/VTVLVesting.sol#L256-L257
...
11. Cache storage values in memory to minimize sloads.
...
https://github.com/code-423n4/2022-09-vtvl/blob/f68b7f3e61dad0d873b5b5a1e8126b839afeab5f/contracts/VTVLVesting.sol#L407

numTokensReservedForVesting should be cached:
https://github.com/code-423n4/2022-09-vtvl/blob/f68b7f3e61dad0d873b5b5a1e8126b839afeab5f/contracts/VTVLVesting.sol#L295
https://github.com/code-423n4/2022-09-vtvl/blob/f68b7f3e61dad0d873b5b5a1e8126b839afeab5f/contracts/VTVLVesting.sol#L301
https://github.com/code-423n4/2022-09-vtvl/blob/f68b7f3e61dad0d873b5b5a1e8126b839afeab5f/contracts/VTVLVesting.sol#L383
https://github.com/code-423n4/2022-09-vtvl/blob/f68b7f3e61dad0d873b5b5a1e8126b839afeab5f/contracts/VTVLVesting.sol#L400
...
mintableSupply should be cached:
...
https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/token/VariableSupplyERC20Token.sol#L40-L43

12. Errors: Use custom errors instead of revert strings
...
https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/VTVLVesting.sol#L107-L111
https://github.com/code-423n4/2022-09-vtvl/blob/f68b7f3e61dad0d873b5b5a1e8126b839afeab5f/contracts/VTVLVesting.sol#L129
https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/VTVLVesting.sol#L255-L278
https://github.com/code-423n4/2022-09-vtvl/blob/f68b7f3e61dad0d873b5b5a1e8126b839afeab5f/contracts/VTVLVesting.sol#L295
...
13. "OR" conditions cost less gas than their equivalent "AND" conditions

Remember that the equivalent of (a && b) is !(!a || !b)

https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/VTVLVesting.sol#L276-L277
https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/VTVLVesting.sol#L344-L349

Example for - https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/VTVLVesting.sol#L276-L277
-L276-L277: (_cliffReleaseTimestamp == 0 && _cliffAmount == 0),
+L276-L276: (!(_cliffReleaseTimestamp != 0 || _cliffAmount != 0)),

Example for - https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/VTVLVesting.sol#L344-L349
-L344-L349: require(_startTimestamps.length == length && _endTimestamps.length == length && _cliffReleaseTimestamps.length == length && _releaseIntervalsSecs.length == length && _linearVestAmounts.length == length && _cliffAmounts.length == length, "ARRAY_LENGTH_MISMATCH");

+L344-L349: require (!(_startTimestamps.length != length || _endTimestamps.length != length || _cliffReleaseTimestamps.length != length || _releaseIntervalsSecs.length != length || _linearVestAmounts.length != length || _cliffAmounts.length != length, "ARRAY_LENGTH_MISMATCH"));

14. Visibility: public functions can be set to external
