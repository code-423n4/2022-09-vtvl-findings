...
|:--:|:-------| :-----:| :-----:|
| [G-01] |Sort solidity operations using short-circuit mode | 9 | 1 |
| [G-02] | Use assembly to write address storage values | 33 | 1 |
| [G-03] | Functions guaranteed to revert when callled by normal users can be marked | 24 | 7 |
| [G-04] | Function ordering via method ID | 22 | All contracts |
| [G-05] | ```x += y``` costs more gas than ```x = x + y``` for state variables | 16 | 4 |
| [G-06] | Use assembly to check for ```address(0)``` | 6 | 4 |
| [G-07] | Using ```>=``` instead of ```>```  is more gas efficient | 3 | 9 |
| [G-08] |Use inline assembly for contract balance |2.4k |2 |
| [G-09] |Use custom errors rather than revert() / require() strings to save deployment gas |68 |24 |
| [G-10] |Setting the constructor to payable |13 |4 |
| [G-11] |Use ```++index instead``` of ```index++``` to increment a loop counter |5 |1 |
| [G-12] |Use a different pattern when using for loops |~400 |1 |
...
**Context:**
[VariableSupplyERC20Token.sol#L28](https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/token/VariableSupplyERC20Token.sol#L28)
...
[VTVLVesting.sol#L325](https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/VTVLVesting.sol#L325)
[VTVLVesting.sol#L341](https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/VTVLVesting.sol#L341)
[VTVLVesting.sol#L398](https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/VTVLVesting.sol#L398)
[VTVLVesting.sol#L418](https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/VTVLVesting.sol#L418)
[VTVLVesting.sol#L446](https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/VTVLVesting.sol#L446)
[VariableSupplyERC20Token.sol#L36](https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/token/VariableSupplyERC20Token.sol#L36)
...
**Recommendation:**
Functions guaranteed to revert when called by normal users can be marked payable  (for only ```onlyAdmin or admin``` functions)
...
## [G-04] Function ordering via method ID [22 gas per instance]
...
For example, the function IDs in the ```VTVLVesting.sol``` contract will be the most used; A lower method ID may be given.

**Proof of Consept:**
https://coinsbench.com/advanced-gas-optimizations-tips-for-solidity-85c47f413dc5

VTVLVesting.sol function names can be named and sorted according to METHOD ID

```js
Sighash   |   Function Signature
========================
89885049  =>  claimableAmount(address)
4cd3723a  =>  getClaim(address)
442cca94  =>  _baseVestedAmount(Claim,uint40)
4a0e701e  =>  vestedAmount(address,uint40)
ed83a4b2  =>  finalVestedAmount(address)
7197dec3  =>  allVestingRecipients()
241c5b1f  =>  numVestingRecipients()
aa22ee48  =>  _createClaimUnchecked(address,uint40,uint40,uint40,uint40,uint112,uint112)
852e72e9  =>  createClaim(address,uint40,uint40,uint40,uint40,uint112,uint112)
ae9741aa  =>  createClaimsBatch(address[],uint40[],uint40[],uint40[],uint40[],uint112[],uint112[])
3ccfd60b  =>  withdraw()
b3a026b1  =>  withdrawAdmin(uint112)
0216ee41  =>  revokeClaim(address)
03350e7b  =>  withdrawOtherToken(IERC20)
```

## [G-05] ```x += y``` costs more gas than ```x = x + y``` for state variables [16 gas per instance]

**Context:**
[VTVLVesting.sol#L161](https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/VTVLVesting.sol#L161)
[VTVLVesting.sol#L179](https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/VTVLVesting.sol#L179)
...
**Context:** 
[AccessProtected.sol#L40](https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/AccessProtected.sol#L40)
[VTVLVesting.sol#L82](https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/VTVLVesting.sol#L82)
[VTVLVesting.sol#L255](https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/VTVLVesting.sol#L255)
[VariableSupplyERC20Token.sol#L37](https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/token/VariableSupplyERC20Token.sol#L37)
...
## [G-07] Using ```>=``` instead of ```>```  is more gas efficient [3 gas per instance]
...
[VariableSupplyERC20Token.sol#L31](https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/token/VariableSupplyERC20Token.sol#L31)
[VariableSupplyERC20Token.sol#L40](https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/token/VariableSupplyERC20Token.sol#L40)
...
## [G-08] Use Inline Assembly for contract balance [2.4k gas per instance]

**Context:**
[VTVLVesting.sol#L400](https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/VTVLVesting.sol#L400)
[VTVLVesting.sol#L448](https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/VTVLVesting.sol#L448)
...
## [G-09] Use Custom Errors Rather Than Revert() / Require() Strings to Save Deployment Gas [68 gas per instance]

**Context:**
[AccessProtected.sol#L25](https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/AccessProtected.sol#L25)
[AccessProtected.sol#L40](https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/AccessProtected.sol#L40)

A total of 24 requirements were found in the project, and two of them were marked as an example.
...
## [G-10] Setting The Constructor To Payable [13 gas per instance]

**Context:**
[AccessProtected.sol#L16](https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/AccessProtected.sol#L16)
[VTVLVesting.sol#L81](https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/VTVLVesting.sol#L81)
[FullPremintERC20Token.sol#L8](https://github.com/code-423n4/2022-09-vtvl/blob/main/contracts/token/FullPremintERC20Token.sol#L8)
...
## [G-12] Use a different pattern when using for loops [~400 gas per instance]
